...
from hubserver.core.config import settings
from hubserver.core.db.database import Base
...
import hubserver.features.models  # noqa: F401 — registry imports all models for Alembic discovery
